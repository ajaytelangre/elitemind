...
public function get_student_petals(Request $request){
     ...
     $dedication_percent=($stud_brainstorming_percentage+$threeHoursperday_percent)/2;
      ...
      $contemplation_percent=round($this->percent($contemplation_y_count,$days), 2);
       ...
       $stud_environment_percentage=(
        ...
        return response()->json([
            "learn_and_tech"=>$stud_learn_tech_percentage,
            "intellectual_break"=>$stud_intellectualbreaks_percentage,
            "rule_of_three"=>$threeHoursperday_percent,
            "brainstromming"=>$stud_brainstorming_percentage,
            "physique"=>$stud_physiques_percentage,
            "environment"=>$stud_environment_percentage,
            "celebrate"=>$stud_celebrate_percentage,
